 ...
 */
require_once THIRDPARTY_PATH . DIRECTORY_SEPARATOR . 'Zend/Cache/Backend/ExtendedInterface.php';

/**
 * @see Zend_Cache_Backend
 */
require_once THIRDPARTY_PATH . DIRECTORY_SEPARATOR . 'Zend/Cache/Backend.php';

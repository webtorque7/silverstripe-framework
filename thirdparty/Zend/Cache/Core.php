...
class Zend_Cache_Core
{
    ...
    protected function _loggerSanity()
    {
        ...
        require_once THIRDPARTY_PATH . DIRECTORY_SEPARATOR . 'Zend/Log/Writer/Stream.php';
        require_once THIRDPARTY_PATH . DIRECTORY_SEPARATOR . 'Zend/Log/Filter/Priority.php';

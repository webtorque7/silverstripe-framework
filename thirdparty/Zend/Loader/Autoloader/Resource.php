...
require_once THIRDPARTY_PATH . DIRECTORY_SEPARATOR . 'Zend/Loader/Autoloader/Interface.php';
...
class Zend_Loader_Autoloader_Resource implements Zend_Loader_Autoloader_Interface
{
    ...
    public function __construct($options)
    {
        ...
        if (!is_array($options)) {
            require_once THIRDPARTY_PATH . DIRECTORY_SEPARATOR . 'Zend/Loader/Exception.php';
        ...
        require_once THIRDPARTY_PATH . DIRECTORY_SEPARATOR . 'Zend/Loader/Autoloader.php';

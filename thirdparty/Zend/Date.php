 ...
 */
require_once THIRDPARTY_PATH . DIRECTORY_SEPARATOR . 'Zend/Date/DateObject.php';
require_once THIRDPARTY_PATH . DIRECTORY_SEPARATOR . 'Zend/Locale.php';
require_once THIRDPARTY_PATH . DIRECTORY_SEPARATOR . 'Zend/Locale/Format.php';
require_once THIRDPARTY_PATH . DIRECTORY_SEPARATOR . 'Zend/Locale/Math.php';
                ...
                switch($name) {
                    case 'format_type' :
                        if ((strtolower($value) != 'php') && (strtolower($value) != 'iso')) {
                            require_once THIRDPARTY_PATH . DIRECTORY_SEPARATOR . 'Zend/Date/Exception.php';

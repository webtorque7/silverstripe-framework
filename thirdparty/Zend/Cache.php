...
abstract class Zend_Cache
{
    ...
    public static function _makeBackend($backend, $backendOptions, $customBackendNaming = false, $autoload = false)
    {
        ...
        if (in_array($backend, Zend_Cache::$standardBackends)) {
            ...
            require_once THIRDPARTY_PATH . DIRECTORY_SEPARATOR . str_replace('_', DIRECTORY_SEPARATOR, $backendClass) . '.php';
        } else {
            ...
            if (!$autoload) {
                ...
                require_once THIRDPARTY_PATH . DIRECTORY_SEPARATOR . $file;
            }
        }
    ...
    public static function _makeFrontend($frontend, $frontendOptions = array(), $customFrontendNaming = false, $autoload = false)
    {
        ...
        if (in_array($frontend, self::$standardFrontends)) {
            ...
            // security controls are explicit
            require_once THIRDPARTY_PATH . DIRECTORY_SEPARATOR . str_replace('_', DIRECTORY_SEPARATOR, $frontendClass) . '.php';
        } else {
    ...
    public static function throwException($msg, Exception $e = null)
    {
        ...
        require_once THIRDPARTY_PATH . DIRECTORY_SEPARATOR . 'Zend/Cache/Exception.php';
